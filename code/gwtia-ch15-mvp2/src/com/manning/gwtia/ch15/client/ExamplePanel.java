...
import com.manning.gwtia.ch15.client.mvp.MvpExample;
...
public class ExamplePanel extends Composite
{
    ...
    public ExamplePanel ()
    {
        ...
        // Little hack to show app if lang param set in url (only needed because we wrap
        // the application in this example panel)
        if ((Window.Location.getParameter("locale")!=null)) showMVPApp();
    }
